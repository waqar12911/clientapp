@extends('layouts.app', ['page' => __('ShockPay'), 'pageSlug' => 'shockpay'])
...
<div class="col-md-12">
    <div class="card ">
        <div class="card-header">
            <div class="row">
                <div class="col-8">
                    <h4 class="card-title">ShockPay</h4>
                </div>
                <div class="col-4 text-right">
                  <a href="#" data-toggle="modal" data-target="#shockpay" class="btn btn-sm btn-primary">Add ShockPay</a>
               </div>
            </div>
        </div>
        <div class="card-body">
          ...
          <tbody>
            @foreach($data as $datum)
                <tr class="custom_color" >
                    <td>{{$datum->shock_pay_contact_name}}</td>
                    <td>{{$datum->shock_pay_contact_Node_ID}}</td>
                    ...
                    <td >
                        ...
                        <a class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this ?');" href="{{route('shockpayDelete',[$datum->id])}}">Delete</a>
                        ...
                        <div class="modal-dialog">
                           ...
                           <div class="modal-content">
                                <div class="modal-body">
                                     <form action="{{route('updateshockpay',$datum->id)}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label for="">Name</label>
                                            <input type="text" class="form-control" value="{{$datum->shock_pay_contact_name}}" required="" name="name">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Node ID</label>
                                            <input type="text" class="form-control" value="{{$datum->shock_pay_contact_Node_ID}}"  required="" name="node_id">
                                        </div>
    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="modal_image">
            <form action="{{route('createshockpay')}}" method="post">
                @csrf
                <div class="form-group">
                    <label for="">Name</label>
                ...
                <div class="form-group">
                    <label for="">Node ID</label>
                    <input type="text" class="form-control" required="" name="node_id">
                </div>
