...
{{--                </li>--}}
                <li class="dropdown nav-item">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <div class="photo" style="border-radius: 0% !important;width: auto;text-align: right;margin-right: 60px;margin-top: 5px;">
                           {{DB::table('client_data')->where('user_id',Auth::user()->id)->first()->client_id ?? "Client App"}}
